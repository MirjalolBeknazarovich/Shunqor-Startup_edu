...
const options = [
    ...
    { id: 2, desc: '2 lorem ipsum'},
    { id: 3, desc: '3 lorem ipsum'},
];
...
const PricingPageComponent = () => {
  ...
  return (
    <>
    <Stack spacing={4} p={10} width={'100%'} direction={'column'}>
        <Stack p={5} alignItems={'center'} justifyContent={{base: 'flex-start', md: 'space-around'}} direction={{base: 'column', md: 'row'}}>
            <Stack w={{base: '100%', md: '40%'}} textAlign={'center'}>
                <Heading size={'lg'}>{t('pricing_title', {ns: 'global'})}<Text color={'gray.400'} >{t('pricing_title_green', {ns: 'global'})}</Text></Heading>
            </Stack>

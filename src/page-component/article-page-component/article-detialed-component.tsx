            ...
            <Card>
                <CardBody>
                    <Box
                        ...
                        pos={'relative'}
                    >
                        <Box pos={'absolute'} top={0} left={0} right={0} bottom={0} bg={'rgba(0, 0, 0, 0.6)'} />
                        <Stack justify={'center'} spacing={3} w={{ base: '100%', lg: '70%' }} pl={{ base: 2, lg: 10 }} pos={'relative'} h={'full'} >
                            ...
                            <HStack>
                                ...
                                <Box>
                                    ...
                                    <Text color={'gray.500'}>{format(new Date(article.createdAt), 'dd. MMM. yyyy')}. {calculateEstimatedRedingTime(article.description.text)} {t('read_article', { ns: 'layout' })}</Text>
                                </Box>
                            </HStack>
                        </Stack>
                    </Box>
...
export default ArticleDetialedComponent;
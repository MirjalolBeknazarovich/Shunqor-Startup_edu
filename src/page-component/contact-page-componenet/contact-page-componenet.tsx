    ...
    <Flex h={'90vh'} justify={'flex-start'} direction={{base: 'column', lg: 'row'}} align={'center'} gap={4} >
        ...
        <Card w={{base: '100%', lg: '60%'}}>
            <CardBody>
                ...
                <Text fontSize={'lg'} mt={4}>{t('contact_text', {ns: 'global'})}</Text>
                <Stack spacing={4} mt={5}>
                    ...
                    <FormControl>
                        ...
                        <Input type="email" placeholder={'example@gmail.com'} h={14} />
                    </FormControl>
                    <FormControl>
                        <FormLabel>{t('contact_message', {ns: 'global'})}</FormLabel>
                        <Textarea placeholder="Body" height={'150px'} />
                    </FormControl>
                    <Button w={'full'} h={14} colorScheme={'facebook'} >{t('contact_btn', {ns: 'global'})}</Button>
                </Stack>
            </CardBody>
        </Card>
    </Flex>
...
export default ContactPageComponenet;
import { Button, FormControl, FormLabel, HStack, Heading, Icon, Input, InputGroup, InputRightElement, PinInput, PinInputField, Progress, Stack, Text, useColorModeValue, useToast } from "@chakra-ui/react";
...
const AccountRecovery = ({ onNavigateStateComponent }: AccountRecoveryProps) => {
  ...
  const onForm3Submit = () => {
    ...
    toast({title: 'Successfully edited', description: 'You can login to account with new password', status: 'success', position: 'top-right', isClosable: true});
  };

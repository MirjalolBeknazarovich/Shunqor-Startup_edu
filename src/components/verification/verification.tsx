import { Button, Center, Heading, HStack, PinInput, PinInputField, Stack, Text, useColorModeValue, useToast } from '@chakra-ui/react';
						...
						<Center >
							<PinInput
								...
								{new Array(6).fill(1).map((_, idx) => (
									<PinInputField
										borderColor={formik.errors.otp && formik.touched.otp ? 'red.500' : 'facebook.500' }
										mx={1}
										key={idx} />
								))}
							</PinInput>

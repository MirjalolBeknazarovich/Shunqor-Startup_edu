        ...
        <Grid minH={'50vh'} gridTemplateColumns={{base: '100%', md: '50% 50%'}} gap={5} justifyContent={"center"} alignContent={"center"} >
          <Stack spacing={3}>
            ...
            <Grid gridTemplateColumns={{base: '100%', md: '50% 50%' }} gap={5}>
              <Button h={14} colorScheme={'facebook'} rightIcon={<VscDebugStart />}>{t('hero_start_learning_btn', {ns: 'home'})}</Button>
              <Button h={14} colorScheme={'facebook'} variant={'outline'}>{t('hero_become_instructor_btn', {ns: 'home'})}</Button>
            </Grid>
          </Stack>
